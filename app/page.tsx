...
export default function HomePage() {
  return (
    <main className="flex min-h-screen flex-col overflow-hidden bg-gradient-to-b from-brand-50/60 via-white to-white">
      <DisclaimerBanner />
      ...
      <div className="relative mx-auto flex w-full max-w-5xl flex-1 flex-col items-center justify-center px-6 py-16 text-center">
        ...
        <span className="mb-5 inline-flex animate-fade-up items-center gap-1.5 rounded-full border border-brand-200 bg-white/80 px-3 py-1 text-xs font-medium text-brand-700 backdrop-blur">
          <span className="h-1.5 w-1.5 rounded-full bg-brand-500" />
          Privacy-first · On-device AI
        </span>

        <h1
          className="animate-fade-up font-display text-5xl italic tracking-tight text-neutral-900 sm:text-7xl"
          style={{ animationDelay: "80ms" }}
        >
          Drish<span className="not-italic text-brand-600">AI</span>
        </h1>

        <p
          className="mt-4 animate-fade-up font-display text-xl text-neutral-700 sm:text-2xl"
        ...
        <p
          className="mx-auto mt-5 max-w-xl animate-fade-up text-sm text-neutral-500 sm:text-base"
        ...
        <div
          className="mt-16 grid animate-fade-up grid-cols-3 gap-8 border-t border-neutral-200 pt-8 text-left sm:gap-16"
        ...
        >
          {[
            ...
            <div key={label}>
              <p className="font-mono text-2xl font-semibold text-brand-700">{stat}</p>
